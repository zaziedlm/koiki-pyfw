...
10. SSO / SAML exchange の Cookie 発行を検証する
11. SSO / SAML invalid state 系の拒否を検証する
12. Cookie jar と CSRF header を扱う test helper を用意する
13. SSO / SAML integration test の mock 方針を決める
    - IdP token endpoint
